...
<#
$CopyDir = "C:\_GitHub\ArtakerStandards\Installer\Installer_Builder\_SourceFiles\JobProcessor"
...
# MessageBox popup when building JobProcesso-Installer
$MessageBoxResult = [System.Windows.Forms.MessageBox]::Show("Would you like to copy necessary Files for the JobProcessor-Installer from SourceFolders?", "Artaker Installer - JobProcessor", [System.Windows.Forms.MessageBoxButtons]::YesNo, [System.Windows.Forms.MessageBoxIcon]::Question)
...
if ($MessageBoxResult -eq "Yes")
{
    ...
    $FolderSyncMatrix = @{
        ...
        "Artaker"     = @{
            ...
            "JobServerTasks" = "FLDR|C:\ProgramData\Artaker\JobServerTasks|True" 
        }
    
        # coolOrange Files
        "coolOrange"  = @{
            "powerJobs" = "FLDR|C:\ProgramData\coolOrange\powerJobs|True"
        }
     
        "VaultConfig" = @{
            "Explorer" = "FILE|C:\Program Files\Autodesk\Vault Client $($AutodeskVersion)\Explorer\JobProcessor.exe.config"
        }
    }
